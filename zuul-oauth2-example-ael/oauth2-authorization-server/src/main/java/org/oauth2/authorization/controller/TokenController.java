...
public class TokenController {
    ...
    @ApiOperation(value = "revok l access token ")
    ...
    @ApiOperation(value = "Récupère la liste des tokens du client Id sampleClientId ")
    ...
    @ApiOperation(value = "revoke refreshtoken by tokenId ")
